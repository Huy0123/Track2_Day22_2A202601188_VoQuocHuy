...
PROMPT_V1_NAME = "voquochuy-rag-prompt-v1"
PROMPT_V2_NAME = "voquochuy-rag-prompt-v2"


# ── 2. Định nghĩa 2 Prompt Templates ──────────────────────────────────────
SYSTEM_V1 = (
    "Bạn là trợ lý AI hữu ích và thân thiện. Dựa vào context sau đây, hãy trả lời câu hỏi thật ngắn gọn, "
    "súc tích và trực diện trong 2-4 câu. Nếu context không có thông tin, hãy nói rõ 'Tôi không tìm thấy thông tin này'."
    "\n\nContext:\n{context}"
)
...
SYSTEM_V2 = (
    "Bạn là chuyên gia phân tích thông tin AI. Hãy phân tích kỹ lưỡng context được cung cấp và trả lời câu hỏi "
    "một cách có cấu trúc rõ ràng, chuyên nghiệp (3-5 câu), trích dẫn luận điểm chính xác từ dữ liệu. "
    "Tuyệt đối không suy đoán ngoài context được cung cấp."
    "\n\nContext:\n{context}"
)
...
def main():
    ...
    log_lines = []
    log_lines.append("=" * 60)
    log_lines.append("  Bước 2: Prompt Hub & A/B Routing")
    log_lines.append("=" * 60)
    ...
    for i, question in enumerate(SAMPLE_QUESTIONS):
        ...
        if version_tag == "v1":
            ...
            v2_count += 1
        line1 = f"[{i+1:02d}] [prompt-{version_tag}] Q: {question[:55]}..."
    ...
    print(f"💾 Đã lưu log vào {evidence_dir / '02_ab_routing_log.txt'}")
